  ...
  return (
    <div className="max-w-[100%] object-cover  mx-auto relative max-md:max-w-full">
      ...
      <Slider {...settings}>
        ...
        <div className="w-fit">
          <img className="w-[100%]"  src="./assets/hero-img/h5.jpg" alt="" />
        </div> <div className="w-fit">
          <img className="w-[100%]"  src="./assets/hero-img/h6.jpg" alt="" />
        </div>
        <div className="w-[100%]">
          <img className="w-[100%]" src="./assets/hero-img/havalandirma.jpg" alt="" />
        </div>
